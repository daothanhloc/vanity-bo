...
/**
 * Api services for the `EffectScript` model.
 */
@Injectable()
export class EffectScriptApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `EffectScript` object.)
   * </em>
   */
